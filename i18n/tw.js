export default {
  ...
  disclaimer: '免責聲明',
  disclaimerContent: [
    `「Absolute DEFI」平台(以下簡稱本服務)，僅係提供貸款人與借貸人間(即貸款雙方)撮合之平台，由貸款人與借貸人於本服務上刊登之抵押質借需求，相關權責及契約成立於貸款人與借貸人雙方，本服務無法，亦不會介入、干涉相關爭議處理。若衍生相關爭議，需由貸款人與借貸人間自行處理及解決。`,
    `近期發生有借貸人對外招募、招攬形成眾籌，此部分均與本服務無關，相關衍生爭議，需由借貸人對外自行處理及解決，亦請利害關係人自行評估借貸人之身分，風險自負。`,
    `您已明確了解並同意「Absolute DEFI」平台提供之服務，包含但不限於網站及手機版網頁及手機應用程式、資料庫系統等程式服務功能，本服務僅以「現狀」提供相關功能使用，且得依其判斷隨時進行規格變更及版本升級，如因此暫時停止服務或產生交易停滯時，不對使用者為任何賠償。`,
    `「Absolute DEFI」提醒您：為保障會員權益，請使用者遵守會員服務條款，如有任何疑問，歡迎來信聯繫我們。`
  ],
  inTransaction: '交易中',
